...
import io.capman.common.RequestContext;
import io.capman.common.RequestContexts;
import io.capman.common.service.BizException;
import io.capman.common.service.RpcProcessor;
import io.capman.common.service.RpcProcessorFactory;
...
public class InternalDispatcher extends  ChannelInboundHandlerAdapter{
    ...
    private Internal.InternalResponse process(Internal.InternalRequest req){
        ...
        RpcProcessor processor = processorFactory.getProcessor(req.getMethod());
        ...
        if (processor == null) {
            ...
            try {
                //business
                byte[] bizRet = processor.process(req.getReqData().toByteArray());
                if(bizRet != null){
                    response.setRespData(ByteString.copyFrom(bizRet));
                }
